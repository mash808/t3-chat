...
function MessageItem({message, session}: {message: Message, session: Session}) {
   ...
   return <li className={liStyles}>
      <div className="flex">
         <time>{message.sentAt.toLocaleTimeString('en-AU', {
            timeStyle: 'short'
   ...
   return <div className="flex flex-col h-screen">
      <div className="flex-1">
         ...
         <form className='flex' onSubmit={(e) => {
            ...
            <textarea className="black p-2.5 w-full text-gray-700 bg-gray-50 rounded-md border border-gray-700" value={message} onChange={(e) => setMessage(e.target.value)} placeholder="What do you want to say?"/>
